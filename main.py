...
def parse_args():
    ...
    parser.add_argument("--pipeline2_params",type= argparser.params_pipelines,metavar= '{"FACTORS":number_required,"EPOCHS":number_required,"NO_FOLDS",2}',help="only considered if --grid_search_impute is not specified")
...
def only_pipeline2(args):
    ...
    pipeline2.do(pipeline2_params,args.gen_submission)
